...
const Schema: z.ZodType<Prisma.VisitsToLocationUncheckedUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const VisitsToLocationUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
