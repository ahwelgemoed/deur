...
const Schema: z.ZodType<Prisma.VisitsToLocationUpdateManyWithoutLocationNestedInput> = z
  .object({
    create: z
      .union([
...
export const VisitsToLocationUpdateManyWithoutLocationNestedInputObjectSchema = Schema;
