...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutLocationNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUncheckedUpdateManyWithoutLocationNestedInputObjectSchema = Schema;
