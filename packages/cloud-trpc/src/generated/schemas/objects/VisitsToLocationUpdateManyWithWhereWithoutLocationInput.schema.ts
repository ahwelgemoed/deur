...
const Schema: z.ZodType<Prisma.VisitsToLocationUpdateManyWithWhereWithoutLocationInput> = z
  .object({
...
export const VisitsToLocationUpdateManyWithWhereWithoutLocationInputObjectSchema = Schema;
