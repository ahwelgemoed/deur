...
const Schema: z.ZodType<Prisma.DevicesUncheckedCreateNestedManyWithoutDeviceTypeInput> = z
  .object({
    create: z
      .union([
...
export const DevicesUncheckedCreateNestedManyWithoutDeviceTypeInputObjectSchema = Schema;
