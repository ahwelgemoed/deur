...
export const devicetypesRouter = t.router({
  aggregateDeviceTypes: publicProcedure
    .input(DeviceTypesAggregateSchema).query(async ({ ctx, input }) => {
  ...
  createOneDeviceTypes: publicProcedure
    .input(DeviceTypesCreateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  deleteManyDeviceTypes: publicProcedure
    .input(DeviceTypesDeleteManySchema).mutation(async ({ ctx, input }) => {
  ...
  deleteOneDeviceTypes: publicProcedure
    .input(DeviceTypesDeleteOneSchema).mutation(async ({ ctx, input }) => {
  ...
  findFirstDeviceTypes: publicProcedure
    .input(DeviceTypesFindFirstSchema).query(async ({ ctx, input }) => {
  ...
  findManyDeviceTypes: publicProcedure
    .input(DeviceTypesFindManySchema).query(async ({ ctx, input }) => {
  ...
  findUniqueDeviceTypes: publicProcedure
    .input(DeviceTypesFindUniqueSchema).query(async ({ ctx, input }) => {
  ...
  groupByDeviceTypes: publicProcedure
    .input(DeviceTypesGroupBySchema).query(async ({ ctx, input }) => {
  ...
  updateManyDeviceTypes: publicProcedure
    .input(DeviceTypesUpdateManySchema).mutation(async ({ ctx, input }) => {
  ...
  updateOneDeviceTypes: publicProcedure
    .input(DeviceTypesUpdateOneSchema).mutation(async ({ ctx, input }) => {
  ...
  upsertOneDeviceTypes: publicProcedure
    .input(DeviceTypesUpsertSchema).mutation(async ({ ctx, input }) => {
