...
export const countriesRouter = t.router({
  ...
  groupByCountry: publicProcedure
    .input(CountryGroupBySchema).query(async ({ ctx, input }) => {
  ...
  updateManyCountry: publicProcedure
    .input(CountryUpdateManySchema).mutation(async ({ ctx, input }) => {
