...
const Schema: z.ZodType<Prisma.VisitsToLocationCreateNestedManyWithoutLocationInput> = z
  .object({
    create: z
      .union([
...
export const VisitsToLocationCreateNestedManyWithoutLocationInputObjectSchema = Schema;
