...
import { DevicesAvgAggregateInputObjectSchema } from './objects/DevicesAvgAggregateInput.schema';
import { DevicesSumAggregateInputObjectSchema } from './objects/DevicesSumAggregateInput.schema';
...
export const DevicesAggregateSchema = z.object({
  ...
  _avg: DevicesAvgAggregateInputObjectSchema.optional(),
  _sum: DevicesSumAggregateInputObjectSchema.optional(),
});
