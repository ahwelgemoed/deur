...
const Schema: z.ZodType<Prisma.DevicesUpdateManyWithoutDeviceTypeNestedInput> = z
  .object({
    create: z
      .union([
...
export const DevicesUpdateManyWithoutDeviceTypeNestedInputObjectSchema = Schema;
