...
const Schema: z.ZodType<Prisma.LocationUpdateManyWithoutCountryNestedInput> = z
  .object({
    create: z
      .union([
...
export const LocationUpdateManyWithoutCountryNestedInputObjectSchema = Schema;
