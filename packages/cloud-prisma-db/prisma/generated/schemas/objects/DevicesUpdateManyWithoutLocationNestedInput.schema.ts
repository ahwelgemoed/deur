...
const Schema: z.ZodType<Prisma.DevicesUpdateManyWithoutLocationNestedInput> = z
  .object({
    create: z
      .union([
...
export const DevicesUpdateManyWithoutLocationNestedInputObjectSchema = Schema;
