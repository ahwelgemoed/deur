...
const Schema: z.ZodType<Prisma.DevicesCreateNestedManyWithoutLocationInput> = z
  .object({
    create: z
      .union([
...
export const DevicesCreateNestedManyWithoutLocationInputObjectSchema = Schema;
