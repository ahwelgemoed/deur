...
const Schema: z.ZodType<Prisma.DevicesUpdateManyWithWhereWithoutLocationInput> = z
  .object({
...
export const DevicesUpdateManyWithWhereWithoutLocationInputObjectSchema = Schema;
