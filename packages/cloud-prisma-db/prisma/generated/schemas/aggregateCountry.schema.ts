...
import { CountryAvgAggregateInputObjectSchema } from './objects/CountryAvgAggregateInput.schema';
import { CountrySumAggregateInputObjectSchema } from './objects/CountrySumAggregateInput.schema';
...
export const CountryAggregateSchema = z.object({
  ...
  _avg: CountryAvgAggregateInputObjectSchema.optional(),
  _sum: CountrySumAggregateInputObjectSchema.optional(),
});
