...
import {
  CompleteUser,
  RelatedUserCloudModel,
  CompleteDevices,
  RelatedDevicesCloudModel,
  CompleteCountry,
  RelatedCountryCloudModel,
 ...
 */
export const RelatedLocationCloudModel: z.ZodSchema<CompleteLocation> = z.lazy(() =>
  LocationCloudModel.extend({
